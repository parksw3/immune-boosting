...
\newline
\\
Sang Woo Park\textsuperscript{1,*}, Michael Li, Chadi Saad-Roy, ???, C. Jessica T. Metcalf, Bryan T. Grenfell, Jonathan Dushoff
\\
\bigskip
...
The boosting model further predicts identical epidemic dynamics as the polarized vaccination model, thereby bridging the differeces between two models.
