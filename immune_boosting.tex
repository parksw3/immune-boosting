...
\jd{I worked for more than half an hour so I'm allowed to say: the intermediate scenario under two-efficacy parameterization is: $\varepsilon_\ell = \varepsilon_z = 1 - \sqrt{1-\varepsilon}$.}
