...
As an example, we assume that both unvaccinated and vaccinated individuals transmit at the same rate $\beta=0.5/\mathrm{day}$ for an average of $1/\gamma=5 \mathrm{day}$ in a homogeneously mixing population. In this case, the force of infection is given by:
\begin{equation}
\lambda = \beta (I_u + I_v)
\end{equation}
