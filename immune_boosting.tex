...
Different assumptions about the effects of vaccination on future infections can predict vastly different epidemiological dynamics.
However, there has been limited discussion about which assumptions are more realistic and therefore more appropriate for making public health decisions.
Here, we show that the differences between two fundamental models for vaccination (namely, leaky and polarized vaccination models) can be explained by the absence and presence of immune boosting---a mechanism via which partially susceptible individuals gain protection after exposure to an infection without developing a transmissible infection.
We show that immune boosting has important implications for measuring vaccine effectiveness.
Our study challenges fundamental assumptions about commonly-used vaccination models and provide a novel framework for understanding epidemiological impact of vaccination.
