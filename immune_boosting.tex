...
\newline
\\
Sang Woo Park\textsuperscript{1,*}, Mike Li, Chadi Saad-Roy, ???, Bryan T Grenfell, Jonathan Dushoff
\\
\bigskip
...
Throughout the paper, we start by assuming that a population mixed homogeneously and that there is no loss of immunity.
...
Since we are modeling a single epidemic without a los of immunity or multiple infections, we consider the reduction in cumulative incidence throughout the entire epidemic.
