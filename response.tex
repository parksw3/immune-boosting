...
I'm wondering if we should write separately to the editor about this ridiculous review.
...
We have proofread the paper again.

\revtext{Reference the models and investigate whether the solutions are positive.}

Our models are built on known models, which we feel we have referenced adequately.
Studying positivity of solutions can be important in a theoretical analysis, but we feel it would detract from our goals here.
In addition, the models presented in this paper follow standard approaches, for which positivity of solutions is widely accepted; in particular, all outflows are simply proportional to the corresponding “stocks” from which they flow.
...
Thanks for this suggestion. We have reviewed these articles, but did not find them particularly salient for this specific paper.
